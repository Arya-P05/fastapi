...
boost library 
layer called swig - python and exel 
servies runnin gon java and jquery 
jenkin
docker
asqwer and aws
argo and hera 
python 3.11 
multithreading lots of it
opening and closing data and connections
felix - codebase older than me 

pay attention to thoery courses - deterministic and non, 
theory of cs is very important 

invest a lot of time into multithreading and embedded systems to high level processes for automation 
what is proper multithreading 
how do you shift locations, etc etcc

look more into canadian companies because we pump out a lot more interesting products 

core of uber eats and ride sharing was made in toronto 
